        ...
        <section className="h-screen flex justify-center">
            <div className="flex">
                <div className="object-contain p-8">
                    <img className="h-full w-auto" src="/public/login_banner.png" alt="login banner" />
                </div>
                <div className="my-auto space-y-6 w-2/5 pl-10">
                    <div className="text-center space-y-6">
                        ...
                        <div className="bg-viking-lighter mx-auto w-max p-2 rounded-full flex gap-10">
                            <Link to="/login" className="px-10 text-white py-1.5 bg-viking-dark rounded-full">Login</Link>
                            <Link to="/register" className="px-10 text-white py-1.5">Register</Link>
                        </div>
                    </div>
                    ...
                    <form className="flex flex-col space-y-6">
                        ...
                        <div className="flex flex-col space-y-2 relative">
                            ...
                            {hidden ? <IoMdEyeOff onClick={handleTogglePassword} className="absolute select-none bottom-2.5 right-4 cursor-pointer" size="20" /> : <IoMdEye onClick={handleTogglePassword} className="absolute bottom-3.5 right-4 cursor-pointer" size="20" />}
                        </div>
                        ...
                        <button className="px-20 py-2 text-lg font-medium self-end text-white bg-viking-dark rounded-full">Login</button>
                    </form>
                </div>
            </div>
        </section>
