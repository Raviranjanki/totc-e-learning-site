    ...
    <section className="h-screen flex justify-center items-center">
      <div className="flex max-w-5xl">
        <div className="hidden lg:flex px-8">
          <img className="object-contain" src="/public/register_banner.png" alt="login banner" />
        </div>
        <div className="my-auto space-y-6 px-6 lg:basis-1/2 lg:w-2/5">
          <div className="text-center space-y-6">
            ...
            <div className="bg-viking-lighter mx-auto w-max p-2 rounded-full flex gap-10">
              <Link to="/login" className="px-10 text-white py-1.5">
                Login
              </Link>
              <Link to="/register" className="px-10 text-white py-1.5 bg-viking-dark rounded-full">
                Register
              </Link>
            </div>
          </div>
